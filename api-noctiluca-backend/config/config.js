...
export const MONGO_URI = `mongodb+srv://noctiluca-admin-api:${encodeURIComponent(PASSWORD_DB)}@api-noctiluca.cimmmgp.mongodb.net/${DB_NAME}?retryWrites=true&w=majority&appName=api-noctiluca`;
